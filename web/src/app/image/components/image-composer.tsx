...
const PROMPT_AREA_DEFAULT_HEIGHT = 108;
const PROMPT_AREA_MAX_HEIGHT = 220;
...
function getPromptAreaMaxHeight() {
  ...
  return Math.max(PROMPT_AREA_MIN_HEIGHT, Math.min(PROMPT_AREA_MAX_HEIGHT, Math.floor(window.innerHeight * 0.28)));
}
