...
func (a *App) routes() []appRoute {
	return []appRoute{
		...
		subtree("/api/admin/billing", a.handleAdminBilling),
		...
		exact("", "/api/pay/yipay/return", a.handleYiPayReturn),
		...
		exact("", "/api/agency/admin/withdrawals", a.handleAgencyAdminWithdrawals),
